...
function subTypeGeneral10(el) {

  document.getElementById("PartofAppl_SubmNoPrevSubm10").removeAttribute("mandatory")
  document.getElementById("PartOfAppl_SubmNo_PareWritPerm10").removeAttribute("mandatory")

  document.getElementById("PartofAppl_SubmNoPrevSubm10").value = ""
  document.getElementById("PartOfAppl_SubmNo_PareWritPerm10").value = ""

  document.getElementById("PartOfAppl_SubmNoPrevSubm").setAttribute("hidden", "")
  document.getElementById("PartOfAppl_SubmNo_PareWritPerm").setAttribute("hidden", "")

  document.getElementById("DeclGeneNewSubm10").setAttribute("hidden", "")
  document.getElementById("DeclGeneResu10").setAttribute("hidden", "")

  for (let a of document.querySelectorAll("[name = 'declTypeNewSubm']")) {
    a.removeAttribute("mandatory");
    a.removeAttribute("checked");
    a.checked = false;
  }

  for (let a of document.querySelectorAll("[name = 'declTypeResu']")) {
    a.removeAttribute("mandatory");
    a.removeAttribute("checked");
    a.checked = false;
  }
  ...
  if (document.getElementById("PartOfAppl_ApplTp10").value) {
    ...
    if (
      ...
      document.getElementById("PartOfAppl_SubmNoPrevSubm").removeAttribute("hidden")
      document.getElementById("PartofAppl_SubmNoPrevSubm10").setAttribute("mandatory", "")
      ...
      document.getElementById("PartOfAppl_SubmNo_PareWritPerm").removeAttribute("hidden")
      document.getElementById("PartOfAppl_SubmNo_PareWritPerm10").setAttribute("mandatory", "")
...
function enableSelect(lbl, sel) {
  ...
  if (yes == true) {
    ...
    document.getElementById(lbl).innerHTML =
      "Does your proposal involve any of the developments below?";
    document.getElementById(sel).value = ""
    document.getElementById(sel).setAttribute("disabled", "");
...
function showPages(el) {
  ...
  if (el.value == "Amendment to Addition/Alteration to Landed Housing") {
    for (let a of document.querySelectorAll("[first-app]")) {
    ...
    el.value ==
    "Amendment to Addition/Alteration to Buildings (others) - Excluding Conserved Buildings within Historic Districts & Residential Historic Districts"
  ) {
    for (let a of document.querySelectorAll("[second-app]")) {
      if (a.hasAttribute("hidden")) {
        a.removeAttribute("hidden");
    ...
    el.value == "Amendment to Addition/Alteration to Conserved Buildings"
  ) {
    for (let a of document.querySelectorAll("[third-app]")) {
      if (a.hasAttribute("hidden")) {
        a.removeAttribute("hidden");
...
// App Type Change
function PartOfAppl_ApplTp10_change(el) {
  let page4Nav = document.querySelector(`[target="page4"]`);
  let page9Content = document.querySelector(`[page9]`);
  let page9Nav = document.querySelector(`[target="page9"]`);
  let page10Nav = document.querySelector(`[target="page10"]`);

  if (el.value == "Amendment to Addition/Alteration to Conserved Buildings") {
    page9Content.setAttribute("hidden", "");
    page9Nav.removeAttribute("page-number");
    page9Nav.setAttribute("hidden", "");
    page10Nav.setAttribute("page-number", "9");
    resetPage9();
  } else {
    page9Content.removeAttribute("hidden");
    page9Nav.setAttribute("page-number", "9");
    page9Nav.removeAttribute("hidden");
    page10Nav.setAttribute("page-number", "10");
    resetPage9();
  }
  ...
  if (
    ...
    page4Nav.setAttribute("label", "Site Address & Change of Use");
  } else {
    page4Nav.setAttribute("label", "Site Address");
  }
}
...
function resetPage9() {
  let enabledFields = [
    document.getElementById("GnryDtls_PropInvoLandRepl10"),
  ...
  let checkbox = [
    ...
    document.getElementById("GnryDtls_GnryFeatures_ChkE10"),
    document.getElementById("GnryDtls_GnryFeatures_ChkF10"),
    document.getElementById("GnryDtls_GnryFeatures_ChkG10"),
    document.getElementById("GnryDtls_GnryFeatures_ChkH10"),
    document.getElementById("GnryDtls_GnryFeatures_ChkI10"),
    document.getElementById("GnryDtls_GnryFeatures_ChkJ10"),
    document.getElementById("GnryDtls_GnryFeatures_ChkK10"),
  ];

  let hideFields = [
    document.getElementById("landscape1"),
  ...
  for (let target of enabledFields) {
...
function calculateGpr_Approved(id) {
  ...
  if (
    ...
    document.getElementById("SiteDtls_GrosPlotRati_IncDec" + suffix).value = 0;
  }

  if (
    isNaN(document.getElementById("SiteDtls_GrosPlotRati_Over" + suffix).value)
  ) {
    document.getElementById("SiteDtls_GrosPlotRati_Over" + suffix).value = 0;
  }

  if (
    isNaN(document.getElementById("SiteDtls_GrosPlotRati_Appr" + suffix).value)
  ) {
    document.getElementById("SiteDtls_GrosPlotRati_Appr" + suffix).value = 0;
  }
}
...
function calculateCpr_Approved(id) {
  ...
  if (
    ...
    document.getElementById("SiteDtls_CommPlotRati_IncDec" + suffix).value = 0;
  }

  if (
    isNaN(document.getElementById("SiteDtls_CommPlotRati_Over" + suffix).value)
  ) {
    document.getElementById("SiteDtls_CommPlotRati_Over" + suffix).value = 0;
  }

  if (
    isNaN(document.getElementById("SiteDtls_CommPlotRati_Appr" + suffix).value)
  ) {
    document.getElementById("SiteDtls_CommPlotRati_Appr" + suffix).value = 0;
  }
}
...
function calculateRpr_Approved(id) {
  ...
  if (
    ...
    document.getElementById("SiteDtls_ResiPlotRati_IncDec" + suffix).value = 0;
  }
  if (
    isNaN(document.getElementById("SiteDtls_ResiPlotRati_Over" + suffix).value)
  ) {
    document.getElementById("SiteDtls_ResiPlotRati_Over" + suffix).value = 0;
  }
  if (
    isNaN(document.getElementById("SiteDtls_ResiPlotRati_Appr" + suffix).value)
  ) {
    document.getElementById("SiteDtls_ResiPlotRati_Appr" + suffix).value = 0;
  }
}
...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  if (document.querySelector("cn2-master-head").hasAttribute("agency")) {
    if (
      document
      ...
      document.getElementById("AgencyFormAddress").value =
...
function fileAttachCheckSelect(element) {
  ...
  let appTypes = [
    "Amendment to Addition/Alteration to Landed Housing",
    "Amendment to Addition/Alteration to Buildings (others) - Excluding Conserved Buildings within Historic Districts & Residential Historic Districts",
    "Amendment to Addition/Alteration to Conserved Buildings",
  ];
...
//Delete JsonData for File Attach
function fileAttachDeleteJson() {
  let GFAcontainer = document.getElementById("GFA_Container");
  let parentDiv = GFAcontainer.querySelectorAll(
    `[prefix="gfa_FormChildAccordionBody"]`
  );
  let GFAswitch = GFAcontainer.querySelectorAll("cn2-switchbutton");
  let switch1 = GFAcontainer.querySelectorAll(
    `[switch-id="SubmInfo_DoesYourPropInvoMechCarp_Yes10"]`
  );
  let switch2 = GFAcontainer.querySelectorAll(
    `[switch-id="SubmInfo_DoesYourPpslInvoSpac_Yes10"]`
  );
  let switch3 = GFAcontainer.querySelectorAll(
    `[switch-id="GfaDtls_IsThisBimSubm_Yes10"]`
  );
  ...
  //switch to NO
  for (let x of GFAswitch) {
    x.checked = false;
  }
  for (let x of switch1) {
    x.checked = false;
  }
  for (let x of switch2) {
    x.checked = false;
  }
  for (let x of switch3) {
    x.checked = false;
  }
}
  ...
  if (document.querySelector('[switch-id="' + baseElementId + '"]').checked) {
    if (!greeneryFeatureIsSelected) {
      ...
      for (let greeneryFeaturesTextbox of greeneryFeaturesCheckboxes) {
        ...
        greeneryFeaturesTextbox.removeAttribute("disabled");
      }
    ...
    for (let greeneryFeaturesTextbox of greeneryFeaturesCheckboxes)
      if (greeneryFeaturesTextbox.hasAttribute("mandatory")) {
        ...
        greeneryFeaturesTextbox.setAttribute("disabled", "");
        greeneryFeaturesTextbox.checked = false;
        enableTextboxBeside(greeneryFeaturesTextbox.id)
      }
  ...
  if (!document.querySelector("[target='page1']").hasAttribute("valid")) {
    ...
    let run = setTimeout(() => {
      ...
      if (Object.values(values.address[0]).every(i => i != "")) {
        ...
        jsonData["agencyURL30"].body = values;
