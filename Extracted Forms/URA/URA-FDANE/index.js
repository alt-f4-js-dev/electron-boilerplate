...
function broadlandUseSwitch(el) {
  console.log(el.checked);
  if (!el.checked == true) {
    document.getElementById("broadlandUse").removeAttribute("hidden");
    document.getElementById("table2").removeAttribute("hidden");
    document.getElementById("table3").removeAttribute("hidden");
  } else {
    document.getElementById("broadlandUse").setAttribute("hidden", "");
    document.getElementById("table2").setAttribute("hidden", "");
    document.getElementById("table3").setAttribute("hidden", "");
  }
}
...
function PartOfAppl_SubmTp_Change(element) {
  ...
  if (
    ...
    if (
      document
        .getElementById("PartOfAppl_TotaMultDeveOpt")
        .hasAttribute("hidden")
    )
      document
        .getElementById("PartOfAppl_TotaMultDeveOpt")
    ...
    // document
    //   .getElementById("PartOfAppl_TotaMultDeveOpt10")
    ...
    document.getElementById("DeclGeneNewSubm_DoesYourPropIn_Yes10").setAttribute("mandatory", "")
    document.getElementById("DeclGeneNewSubm_DoesYourPropIn_No10").setAttribute("mandatory", "")

    document.getElementById("DeclGeneNewSubm_DoesYourPropIn_Yes10").setAttribute("checked", "")
    document.getElementById("DeclGeneNewSubm_DoesYourPropIn_No10").setAttribute("checked", "")
    ...
    document.getElementById("DeclGeneResu_DoesYourPropIn_Yes10").setAttribute("checked", "")
    document.getElementById("DeclGeneResu_DoesYourPropIn_No10").setAttribute("mandatory", "")
    if (
      document
        .getElementById("PartOfAppl_SubmNoPrevSubm")
        .hasAttribute("hidden")
    ...
    if (document.getElementById("DeclGeneResu10").hasAttribute("hidden")) {
      ...
      document.getElementById("DeclGeneResu_DoesYourPropIn_Yes10").setAttribute("mandatory", "")
      document.getElementById("DeclGeneResu_DoesYourPropIn_No10").setAttribute("mandatory", "")

      document.getElementById("DeclGeneResu_DoesYourPropIn_Yes10").setAttribute("checked", "")
      document.getElementById("DeclGeneResu_DoesYourPropIn_No10").setAttribute("checked", "")
    }
  }
}
...
function enableTextboxBeside1(checkboxId) {
  let fields = [
    document.getElementById("GnryDtls_GnryFeatures_Area10"),
    document.getElementById("GnryDtls_GnryFeatures_Area20"),
    document.getElementById("GnryDtls_GnryFeatures_Area30"),
    document.getElementById("GnryDtls_GnryFeatures_Area40"),
  ];
  let textbox = document.getElementById(checkboxId).parentNode;
  let test = false;
