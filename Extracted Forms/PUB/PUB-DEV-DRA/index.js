function Project_StagOfDeve10_change(thisElement) {
  let field = document.getElementById("Project_StagOfDeve_Desc10");
  let label = document.getElementById("Project_StagOfDeve_Desc10_label");

  if (thisElement.value == "Others") {
    document.getElementById("ifOther10").removeAttribute("hidden");
    field.setAttribute("mandatory", "");
    field.removeAttribute("disabled");
    label.innerText += " *";
  } else {
    document.getElementById("ifOther10").setAttribute("hidden", "");
    field.value = "";
