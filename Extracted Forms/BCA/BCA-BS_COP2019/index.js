...
function showByAppType(el) {
  ...
  if (appTypeVal == "bs01") {
    ...
    document.querySelector("[bs0103]").innerHTML = "a"
    ...
    document.querySelector("[bs0103]").innerHTML = "an"
    for (let a of document.querySelectorAll("[copLabel2]")) {
...
function appTypeChanged(type) {
  ...
  if (types.includes(type)) {
    ...
    let formName = ["BCA-BS01_COP2019", "BCA-BS02_COP2019", "BCA-BS03_COP2019"];
...
function validateProjectDetailsPage() {
  ...
  stopHere: for (let a of document
    ...
    if (a.id != "CalcOfOverBuil_ProjDetl_ProjSubmOutcPropE20") {
...
function devType(el) {
  ...
  if (
    ...
    document
      .getElementById("CalcOfOverBuil_ProjDetl_ProjSubmOutcPropE20")
  ...
  if (el.id == "CalcOfOverBuil_ProjDetl_ProjCompWithMini10") {
...
function BDS_BLK(el) {
  ...
  for (let a of prefixes) {
    let val = page.querySelector("[prefix='" + a + prefix + "']").value;
...
function showParticularTotals(el) {
  ...
  if (aCheckbox.some((r) => r.checked === true)) {
    ...
    if (id === "CalcOfOverBuil_ProjDetl_ProjSubmOutcPropE10") {
  ...
  if (document.getElementById("CalcOfOverBuil_ProjDetl_ProjCompWithMini10").checked) {
    if (a.checked) {
      aSuper.value = document.getElementById(
        "CalcOfOverBuil_BuilDesiScoreSumm_TotaBuilDesiScorForThisProj10"
      ).value;
