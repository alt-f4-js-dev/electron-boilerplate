function PartOfAppl_SubmTp10_Change_Local() {
  document.querySelector('[target="page10"]').hasAttribute("hidden")
...
function enableTextboxBesideNotManda(checkboxId) {
...
function subTypeGeneral(el, newSubs, reSubs) {
  ...
  if (
    ...
    document
      .getElementById("PartOfAppl_SubmNo_PareWritPerm10")
...
function subTypeGeneral2(el, newSubs, reSubs) {
  ...
  if (document.getElementById("PartOfAppl_ApplTp10").value) {
    ...
    if (
      ...
      emptyValueAll(reSubs);
      setMandatoryToM(document.querySelectorAll("#" + reSubs));
      setMToMandatory(document.querySelectorAll("#" + newSubs));
      ...
      emptyValueAll(newSubs);
      setMToMandatory(document.querySelectorAll("#" + reSubs));
      setMandatoryToM(document.querySelectorAll("#" + newSubs));
  ...
  if (document.querySelector('[switch-id="' + baseElementId + '"]').checked) {
    ...
    for (let greeneryFeaturesTextbox of greeneryFeaturesCheckboxes)
      if (greeneryFeaturesTextbox.hasAttribute("mandatory")) {
        ...
        enableTextboxBeside1(greeneryFeaturesTextbox.id)
      }
