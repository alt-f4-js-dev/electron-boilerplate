  ...
  if (document.getElementById("PartOfAppl_ApplTp10").value) {
    ...
    if (
      ...
      document
        ...
        .setAttribute("hidden", "");
      if (document.getElementById("PartOfAppl_SubmNoPrevSubm10").hasAttribute("mandatory"))
        document
    ...
    if (
      ...
      document
        .getElementById("PartOfAppl_SubmNo_PareWritPerm")
        .setAttribute("hidden", "");
      if (document.getElementById("PartOfAppl_SubmNo_PareWritPerm10").hasAttribute("mandatory"))
        document
          .getElementById("PartOfAppl_SubmNo_PareWritPerm10")
          .removeAttribute("mandatory");
      emptyValueAll("PartOfAppl_SubmNo_PareWritPerm");
...
function checkRoleInput(element, con) {
  ...
  if (value == "Agent (i.e. QP)") {
    document.getElementById("Member_Member_Name_QP10").setAttribute("event-change", "loadDropDownDetailsURA(this);populateSignedBy('MemberRole_Member_Role_Code_Desc_QP10', 'Member_Member_Name_QP10', false);");
  }
...
function appType(el, subType, trs) {
  ...
  for (let a of trs) {
    ...
    if (document.getElementById(a).querySelector("cn2-textbox").hasAttribute("mandatory"))
      document.getElementById(a).querySelector("cn2-textbox").removeAttribute("mandatory");
    emptyValueAll(a);
  }
  ...
  while (document.getElementById(rolePrefix + ctr + roleSuffix) != null) {
    if (
      ...
      if (
        ...
        } else if (document.getElementById("DeclSubdResu_SignBy10")) {
          document.getElementById(
