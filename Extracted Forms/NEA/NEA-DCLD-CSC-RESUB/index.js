...
function PartOfAppl_change(element, checkbox) {
...
document.addEventListener("DOMContentLoaded", function (event) {
  let title = `APPLICATION FOR COMPLIANCE CERTIFICATE - RESUBMISSION<br>[Under Section 33(7) Of The Environmental Protection And Management Act (Chapter 94A)] `;
