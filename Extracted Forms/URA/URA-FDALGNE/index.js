...
function PartOfAppl_LodgTp10_Change(sourceElement) {
  emptyValueAll(document.getElementById("page10"));

  function hideAgri() {
    for (let a of document.querySelectorAll("[lodge-agri]")) {
    ...
    document
      ...
      .setAttribute(
        "title",
        "LODGEMENT FOR NEW ERECTION (INCLUDING RECONSTRUCTION TO LANDED HOUSING)"
      );
  }
  ...
  if (sourceElement.value === "Residential (Landed Housing Area)") {
    // changes for Agriculture Development
    document
      .querySelector(`[SubmInfo_PropForCndo_Yes10_hide]`)
      .removeAttribute("hidden");
    document.getElementById("SubmInfo_DateOfLeasExpi10").removeAttribute("mandatory")
    let fields = document.querySelectorAll(
      '[group-code="100"],[group-code="101"]'
    );

    for (let field of fields) {
      if (field.hasAttribute("hidden")) field.removeAttribute("hidden");
      let mandatoryElements = field.querySelectorAll("[m]");
      if (mandatoryElements.length > 0) {
        for (let mandatoryElement of mandatoryElements) {
          mandatoryElement.removeAttribute("m");
          mandatoryElement.setAttribute("mandatory", "");
        }
      }
    }

    //hide not applicable fields
    fields = document.querySelectorAll('[group-code="011"]');

    for (let field of fields) {
      field.setAttribute("hidden", "");
      let optionalElements = field.querySelectorAll("[mandatory]");
      if (optionalElements.length > 0) {
        for (let optionalElement of optionalElements) {
          optionalElement.removeAttribute("mandatory");
          optionalElement.setAttribute("m", "");

          if (optionalElement.checked != null) optionalElement.checked = false;
          else if (optionalElement.value != null) optionalElement.value = "";
        }
      }
    }

    document.getElementById("SubmInfo_PropDesc10").value = "";
    document.getElementById("SubmInfo_PropDesc10").value = "ERECTION OF A #-STOREY ? DEVELOPMENT COMPRISING # BLOCK(S) OF #-STOREY BUILDING(S) WITH ? ERECTION OF ? UNITS OF #-STOREY ENVELOPE CONTROL ? DWELLING HOUSES WITH?"
    document.getElementById("SubmInfo_PropDesc10").removeAttribute("mandatory")
    // //for declaration
    // let declarationFields1 = document.querySelectorAll("[residU]");
    // for (let declarationField of declarationFields1) {
    //   if (declarationField.hasAttribute("hidden"))
    //     declarationField.removeAttribute("hidden");
    // }

    // declarationFields2 = document.querySelectorAll("[jtcU]");
    // for (let declarationField of declarationFields2) {
    //   declarationField.setAttribute("hidden", "");
    // }

    // declarationFields3 = document.querySelectorAll("[hdbU]");
    // for (let declarationField of declarationFields3) {
    //   declarationField.setAttribute("hidden", "");
    // }

    // declarationFields4 = document.querySelectorAll("[agri]");
    // for (let declarationField of declarationFields4) {
    //   declarationField.setAttribute("hidden", "");
    // }
  ...
  //Industrial/Warehouse Development(JTC)
  else if (sourceElement.value === "Industrial/Warehouse Development(JTC)") {
    //changes for Agriculture Development
    document
      .querySelector(`[SubmInfo_PropForCndo_Yes10_hide]`)
      .setAttribute("hidden", "");
    document.getElementById("SubmInfo_DateOfLeasExpi10").removeAttribute("mandatory")
    let fields = document.querySelectorAll('[group-code="011"]');
    ...
    document.getElementById("SubmInfo_PropDesc10").value = "";
    document.getElementById("SubmInfo_PropDesc10").value = "ERECTION OF A #-STOREY ? DEVELOPMENT COMPRISING # BLOCK(S) OF #-STOREY BUILDING(S) WITH ?"
    ...
    //for declaration
    // let declarationFields1 = document.querySelectorAll("[jtcU]");
    // for (let declarationField of declarationFields1) {
    //   if (declarationField.hasAttribute("hidden"))
    //     declarationField.removeAttribute("hidden");
    // }

    // declarationFields2 = document.querySelectorAll("[residU]");
    // for (let declarationField of declarationFields2) {
    //   declarationField.setAttribute("hidden", "");
    // }
  ...
  //Residential Development (HDB)
  else if (sourceElement.value === "Residential Development (HDB)") {
    // changes for Agriculture Development
    document
      .querySelector(`[SubmInfo_PropForCndo_Yes10_hide]`)
      .setAttribute("hidden", "");
    ...
    //hide not applicable fields
    fields = document.querySelectorAll('[group-code="100"]');
    ...
    //for declaration
    // let declarationFields1 = document.querySelectorAll("[hdbU]");
    // for (let declarationField of declarationFields1) {
    //   if (declarationField.hasAttribute("hidden"))
    //     declarationField.removeAttribute("hidden");
    // }
    ...
    // declarationFields3 = document.querySelectorAll("[jtcU]");
    // for (let declarationField of declarationFields3) {
    //   declarationField.setAttribute("hidden", "");
    // }
  ...
  //Agriculture Development
  else if (sourceElement.value === "Agriculture Development") {
    //Submission Info
    document
      .querySelector(`[SubmInfo_PropForCndo_Yes10_hide]`)
      .removeAttribute("hidden");
    document.getElementById("SubmInfo_DateOfLeasExpi10").setAttribute("mandatory", "")
    ...
    //for declaration
    // let declarationFields1 = document.querySelectorAll("[agri]");
    // for (let declarationField of declarationFields1) {
    //   if (declarationField.hasAttribute("hidden"))
    //     declarationField.removeAttribute("hidden");
    // }

    // let declarationFields2 = document.querySelectorAll("[hdbU]");
    // for (let declarationField of declarationFields2) {
    //   declarationField.setAttribute("hidden", "");
    // }

    // declarationFields3 = document.querySelectorAll("[residU]");
    // for (let declarationField of declarationFields3) {
    //   declarationField.setAttribute("hidden", "");
    // }

    // declarationFields4 = document.querySelectorAll("[jtcU]");
    // for (let declarationField of declarationFields4) {
    //   declarationField.setAttribute("hidden", "");
    // }
    ...
    document
      ...
      .setAttribute(
        "title",
        "Agriculture Plan Lodgment for New Erection".toUpperCase()
      );
  }
...
function DeclLodgSubd_QpName10_change(element) {
  document.getElementById(
    "DeclLodgSubd_QpName10"
  ).value = document.getElementById("Member_Member_Name_QP10_0").value;
}
...
function setMToMandatoryDIV(con) {
  if (con) {
    for (let a of document.getElementById(con).querySelectorAll("[m]")) {
      if (a.hasAttribute("m")) a.removeAttribute("m");
      a.setAttribute("mandatory", "");
      if (a.hasAttribute("c")) a.removeAttribute("c");
...
function SubmInfo_TpOfFrgnWkrsDorm10_change() {
  document
...
//===============================================================================================IN URA COMMON DELETE AFTER URA COMMON IS COMMITTED
    ...
    if (
      ...
      if (
        ...
        if (general2) {
          ...
          if (document.getElementById("DeclLodgAgriDeve_SignBy10"))
            document.getElementById(
              "DeclLodgAgriDeve_SignBy10"
            ).value = document.getElementById(
              namePrefix + ctr + nameSuffix
            ).shadowRoot.querySelector("select").querySelector('option[value=' + '"' + document.getElementById(
              namePrefix + ctr + nameSuffix
...
function ApptypeInternalCheckList() {
  ...
  let parentDiv = page8.querySelectorAll(
    `[prefix="gfa_FormChildAccordionBody"]`
  );
  let switchbutton = page8.querySelectorAll("cn2-switchbutton");
