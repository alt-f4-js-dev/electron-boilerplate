...
function subType(el, newSubs, reSubs) {
  ...
  if (document.getElementById("PartOfAppl_ApplTp10").value) {
    if (
      ...
      document.getElementById(el.id).shadowRoot.querySelector("select").style.backgroundColor = "white";

      emptyValueAll(reSubs);
      setMandatoryToM(document.querySelectorAll("#" + reSubs));

      if (document.getElementById("PartOfAppl_ApplTp10").value === "Change of Use (excluding Conserved Buildings outside Historic Districts & Residential Historic Districts)")
...
// Submission page toggle
function submissionInfoToggle(el) {
  document.querySelector("[target='page7']").setAttribute("hidden", "");
  ...
  if (
    el.value ==
    "Change of Use (excluding Conserved Buildings outside Historic Districts & Residential Historic Districts)"
  ) {

    if (document.querySelectorAll("[app-type='1']")) {
      for (let a of document.querySelectorAll("[app-type='1']")) {
        a.removeAttribute("hidden");
        let b = a.querySelectorAll("tr");
        setMToMandatory(b);
        let switchField = a.querySelectorAll("[switch-tr]");
        for (let a of switchField) {
          let switchDefault = a.parentElement.querySelector("[default]");

          a.innerHTML = "";
          a.innerHTML = switchDefault.innerHTML;
        }
    ...
    document.getElementById("SubmInfo_NoOfBedsForFrgnWkrs10").setAttribute("mandatory", "");
    document.getElementById("SubmInfo_NoOfBedsForFrgnWkrs10").removeAttribute("mandatory");
    document.getElementById("SubmInfo_NoOfBedsForFrgnWkrs10").value = "";

    if (document.querySelectorAll("[app-type='2']")) {
      for (let a of document.querySelectorAll("[app-type='2']")) {
    ...
    if (document.querySelectorAll("[app-type='2']")) {
      for (let a of document.querySelectorAll("[app-type='2']")) {
        ...
        a.querySelector("#SubmInfo_PropDesc10").value = "CHANGE OF USE/RETENTION OF THE #-STOREY UNIT # ? OF THE #-STOREY BUILDING FROM ? TO ?";
      }
    }
...
// For formatting the YES/NO radio in each declarations
function PartOfAppl_SubmTp10_Change2(element) {
  if (document.getElementById("PartOfAppl_ApplTp10").value === "") {
    document.querySelector('[target="page7"]').setAttribute("page-number", "6")
  } else {
  ...
  if (
    ...
    if (document.getElementById("DeclGeneNewSubm10").hasAttribute("hidden")) {
      ...
      document.getElementById("DeclGeneResu_DoesYourPropIn_Yes10").removeAttribute("checked");
      document.getElementById("DeclGeneResu_DoesYourPropIn_Yes10").removeAttribute("mandatory");
      document.getElementById("DeclGeneResu_DoesYourPropIn_No10").removeAttribute("mandatory");
      document.getElementById("DeclGeneResu_DoesYourPropIn_No10").removeAttribute("checked");
      //resubmission
  ...
  if (
    ...
    if (document.getElementById("DeclGeneResu10").hasAttribute("hidden")) {
      ...
      document
        .getElementById("DeclGeneResu_DoesYourPropIn_No10")
        .setAttribute("checked", "");
      document.getElementById("DeclGeneNewSubm_DoesYourPropIn_Yes10").removeAttribute("checked");
      document.getElementById("DeclGeneNewSubm_DoesYourPropIn_Yes10").removeAttribute("mandatory");
      document.getElementById("DeclGeneNewSubm_DoesYourPropIn_No10").removeAttribute("mandatory");
      document.getElementById("DeclGeneNewSubm_DoesYourPropIn_No10").removeAttribute("checked");
...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  if (document.querySelector("[target='page8']")) {
    ...
    if (!document.querySelector("[target='page1']").hasAttribute("valid") && totalNonBonusGFASum == 0) {
      for (let a of document.querySelectorAll("[target]")) {
        a.addEventListener('click', (event) => {
          if (!document.querySelector("[target='page8']").hasAttribute("selected")) {
            isValid = true;

            stopHere:
            for (let a of document.getElementById("page8").querySelectorAll("[approved-use-gfa-nonbonus]")) {
            ...
            if (!isValid) {
              ...
              showMessage('[Sum of [Use GFA] for one site (for items that do not include Bonus GFA Items) must be equal to the [Total GFA] in Site details.]');
            }
          }
        });
      }
      document.querySelector("cn2-fixed-footer").shadowRoot.getElementById("footer-next").addEventListener('click', (event) => {
        if (!document.querySelector("[target='page8']").hasAttribute("selected")) {
          isValid = true;
      ...
      document.querySelector("cn2-fixed-footer").shadowRoot.getElementById("footer-previous").addEventListener('click', (event) => {
        if (!document.querySelector("[target='page8']").hasAttribute("selected")) {
          isValid = true;
  ...
  for (let a of document.querySelectorAll("[gpr-total]")) {
    !isNaN(parseFloat(a.value)) ? totalNonBonusGFASum += parseFloat(a.value) : totalNonBonusGFASum += 0;
  }
...
function duplicateForm(formContainer, fieldContainer, field, status) {
  ...
  if (clonedForm.querySelector("[total-gfa]")) {
    ...
    current.setAttribute("event-input", "totalGFA(this, '" + clonedForm.id + "');");
  }
  ...
  if (clonedForm.querySelectorAll("[calculate-gpr]")) {
    for (let a of clonedForm.querySelectorAll("[calculate-gpr]")) {
      ...
      a.setAttribute("event-input", "calculateGPR('" + clonedForm.id + "'); totalNonBonusGFA();");
    }
  }
      ...
      for (let a of document.getElementById(con).querySelectorAll(x)) {
        if (
          ...
          if (document.getElementById(a.id).hasAttribute("default-value")) {
            document.getElementById(a.id).value = document.getElementById(a.id).getAttribute("default-value");
          } else {
            document.getElementById(a.id).value = "";
          }
        }
...
function populateMDO(el) {
  ...
  for (let a of trs) {
    if (el.value == "2") {
      ...
      if (document
        .getElementById(a.id)
        .querySelector("cn2-select").hasAttribute("mandatory")) {
        document
          .getElementById(a.id)
          .querySelector("cn2-select").setAttribute("mandatory", "");
        document
          .getElementById(a.id)
          .querySelector("cn2-select").removeAttribute("mandatory");
        document.getElementById(a.id).querySelector("cn2-select").setAttribute("m", "");
      }
      emptyValueAll(a.id);
...
function appType(el, subType, trs) {
  ...
  if (document.getElementById("DeclGeneResu_DoesYourPropIn_Yes10")) {
    if (document.getElementById("DeclGeneResu_DoesYourPropIn_Yes10").hasAttribute("checked"))
      document.getElementById("DeclGeneResu_DoesYourPropIn_Yes10").removeAttribute("checked");
    if (document.getElementById("DeclGeneResu_DoesYourPropIn_Yes10").hasAttribute("mandatory"))
      document.getElementById("DeclGeneResu_DoesYourPropIn_Yes10").removeAttribute("mandatory");
  }
  if (document.getElementById("DeclGeneResu_DoesYourPropIn_No10")) {
    if (document.getElementById("DeclGeneResu_DoesYourPropIn_No10").hasAttribute("checked"))
      document.getElementById("DeclGeneResu_DoesYourPropIn_No10").removeAttribute("checked");
    if (document.getElementById("DeclGeneResu_DoesYourPropIn_No10").hasAttribute("mandatory"))
      document.getElementById("DeclGeneResu_DoesYourPropIn_No10").removeAttribute("mandatory");
  }
  ...
  if (document.getElementById("DeclGeneNewSubm_DoesYourPropIn_Yes10")) {
    if (document.getElementById("DeclGeneNewSubm_DoesYourPropIn_Yes10").hasAttribute("checked"))
      document.getElementById("DeclGeneNewSubm_DoesYourPropIn_Yes10").removeAttribute("checked");
    if (document.getElementById("DeclGeneNewSubm_DoesYourPropIn_Yes10").hasAttribute("mandatory"))
      document.getElementById("DeclGeneNewSubm_DoesYourPropIn_Yes10").removeAttribute("mandatory");
  }
  if (document.getElementById("DeclGeneNewSubm_DoesYourPropIn_No10")) {
    if (document.getElementById("DeclGeneNewSubm_DoesYourPropIn_No10").hasAttribute("checked"))
      document.getElementById("DeclGeneNewSubm_DoesYourPropIn_No10").removeAttribute("checked");
    if (document.getElementById("DeclGeneNewSubm_DoesYourPropIn_No10").hasAttribute("mandatory"))
      document.getElementById("DeclGeneNewSubm_DoesYourPropIn_No10").removeAttribute("mandatory");
  }
...
function validateEmail(element) {
  ...
  if (!re.test(String(element.value).toLowerCase()) && element.value != "") {
    ...
    document
      .getElementById(element.id)
      .setAttribute("data-invalid-message", "Invalid Format. Please try again.");
  } else {
...
function checkBonusGFA(callerId, from) {
  if (document.querySelector("[target='page8']").hasAttribute("gfa-non-bonus")) {
    let container = "";
    ...
    if (from == "check") {
      ...
      if (document.getElementById(callerId).value.toLowerCase().includes("bonus")) {
        if (container.querySelector("[prefix='GfaDtls_UseGfa_Appr']").hasAttribute("approved-use-gfa-nonbonus"))
          container.querySelector("[prefix='GfaDtls_UseGfa_Appr']").removeAttribute("approved-use-gfa-nonbonus")
      } else {
        container.querySelector("[prefix='GfaDtls_UseGfa_Appr']").setAttribute("approved-use-gfa-nonbonus", "")
      }
      ...
      if (
        ...
        if (
          ...
          if (document.getElementById("DeclTopCscMonu_SignBy10"))
            document.getElementById(
              "DeclTopCscMonu_SignBy10"
            ).value = document.getElementById(
              namePrefix + ctr + nameSuffix
            ).value;
          if (document.getElementById("DeclTOPCNonCons_SignBy10"))
            document.getElementById(
              "DeclTOPCNonCons_SignBy10"
            ).value = document.getElementById(
              namePrefix + ctr + nameSuffix
            ).value;
          if (document.getElementById("DeclLodgResiNew_SignBy10"))
            document.getElementById(
              "DeclLodgResiNew_SignBy10"
            ).value = document.getElementById(
              namePrefix + ctr + nameSuffix
            ).value;
          ...
          if (document.getElementById("DeclLodgResiDeve_SignBy10"))
            document.getElementById(
              "DeclLodgResiDeve_SignBy10"
            ).value = document.getElementById(
              namePrefix + ctr + nameSuffix
            ).value;
        } else if (
...
// function loadOptionChange(el) {
//   let roleValue = document.getElementById(el.id).valueLabel
//   let idIndex = document.getElementById(el.id).getAttribute("id").replace(document.getElementById(el.id).getAttribute("prefix"), "");
//   let nameSelect = document.getElementById("Member_Member_Name_QP" + idIndex)

//   switch (roleValue) {
//     case "Architect":
//       nameSelect.removeAttribute("data-options")
//       nameSelect.setAttribute("data-options", "persAndOrgsDropdownArch")
//       break;
//     case "Engineer":
//       nameSelect.removeAttribute("data-options")
//       nameSelect.setAttribute("data-options", "persAndOrgsDropdownEngr")
//       break;
//     case "Lessee":
//       nameSelect.removeAttribute("data-options")
//       nameSelect.setAttribute("data-options", "persAndOrgsDropdownLessee")
//       break;
//     case "Lessor":
//       nameSelect.removeAttribute("data-options")
//       nameSelect.setAttribute("data-options", "persAndOrgsDropdownLessor")
//       break;
//     case "Management Corporation Strata Title":
//       nameSelect.removeAttribute("data-options")
//       nameSelect.setAttribute("data-options", "persAndOrgsDropdownMngmnt")
//       break;
//     case "Others":
//       nameSelect.removeAttribute("data-options")
//       nameSelect.setAttribute("data-options", "persAndOrgsDropdownOthr")
//       break;
//     case "Prospective Purchaser":
//       nameSelect.removeAttribute("data-options")
//       nameSelect.setAttribute("data-options", "persAndOrgsDropdownPropur")
//       break;
//     case "Surveyor":
//       nameSelect.removeAttribute("data-options")
//       nameSelect.setAttribute("data-options", "persAndOrgsDropdownSurv")
//       break;
//     case "Tenant":
//       nameSelect.removeAttribute("data-options")
//       nameSelect.setAttribute("data-options", "persAndOrgsDropdownTena")
//       break;
//   }
