...
function PartOfAppl_ApplTp10_change(el) {
  ...
  let textBox = document.getElementById("SubmInfo_PropDesc10");
  textBox.value = ""
  if (selectValue == "Renewal of Temporary Written Permission for Temporary Structures and Uses") {
    textBox.value = "EXTENSION OF TEMPORARY PERMISSION FOR ADDITION/ALTERATION TO THE EXISTING #-STOREY ? BUILDING"
  } else if (selectValue == "Renewal of Temporary Written Permission for Continued Use (excluding Conserved Buildings within Historic Districts & Residential Historic Districts)") {
    textBox.value = "CONTINUED USE OF THE #-STOREY UNIT #? Of THE #-STOREY BUILDING FROM ? TO ?"
  } else {
    textBox.value = "CONTINUED USE/RETENTION OF Use OF THE #-STOREY UNIT #? Of THE #-STOREY BUILDING FROM ? TO ?"
  }
}
