function PartOfAppl_SubmTp_Change(element) {
  if (document.getElementById("PartOfAppl_ApplTp10").value) {
    ...
    if (
      ...
      //for declaration
      let newSubs = document.getElementsByClassName("DeclSubNew");
      let reSubs = document.getElementsByClassName("DeclSubRe");

      for (let a of newSubs) {
    ...
    if (
      ...
      emptyValueAll("PartOfAppl_SubmNoPrevSubm");
...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  if (document
    .querySelector("cn2-master-head").hasAttribute("agency")) {
    if (
      document
...
function subTypeTwoSel(el, resub, newsub) {
  if (document.getElementById("PartOfAppl_ApplTp10").value != "") {
    if (document.getElementById(el.id).value != "") {
      ...
      if (document.querySelector("cn2-nav-button[label='Declaration']").hasAttribute("hidden"))
        document.querySelector("cn2-nav-button[label='Declaration']").removeAttribute("hidden");

      if (el.value == "New Submission (for fresh submission and fresh amendment submission to Written Permission)") {
        if (document.getElementById(newsub).hasAttribute("hidden"))
          document.getElementById(newsub).removeAttribute("hidden");
        document.getElementById(newsub).querySelector("[newsub-field]").setAttribute("mandatory", "");

        document.getElementById(resub).setAttribute("hidden", "");
        if (document.getElementById(resub).querySelector("[resub-field]").hasAttribute("mandatory"))
          document.getElementById(resub).querySelector("[resub-field]").removeAttribute("mandatory");
        document.getElementById(resub).querySelector("[resub-field]").value = "";
        if (document.getElementById(resub).querySelector("[resub-field]").hasAttribute("data-invalid"))
          document.getElementById(resub).querySelector("[resub-field]").removeAttribute("data-invalid");
        if (document.getElementById(resub).querySelector("[resub-field]").hasAttribute("data-invalid-message"))
          document.getElementById(resub).querySelector("[resub-field]").removeAttribute("data-invalid-message");
      } else {
        if (document.getElementById(resub).hasAttribute("hidden"))
          document.getElementById(resub).removeAttribute("hidden");
        document.getElementById(resub).querySelector("[resub-field]").setAttribute("mandatory", "");

        document.getElementById(newsub).setAttribute("hidden", "");
        if (document.getElementById(newsub).querySelector("[newsub-field]").hasAttribute("mandatory"))
          document.getElementById(newsub).querySelector("[newsub-field]").removeAttribute("mandatory");
        document.getElementById(newsub).querySelector("[newsub-field]").value = "";
        if (document.getElementById(newsub).querySelector("[newsub-field]").hasAttribute("data-invalid"))
          document.getElementById(newsub).querySelector("[newsub-field]").removeAttribute("data-invalid");
        if (document.getElementById(newsub).querySelector("[newsub-field]").hasAttribute("data-invalid-message"))
          document.getElementById(newsub).querySelector("[newsub-field]").removeAttribute("data-invalid-message");
      }
    }
  }
}
