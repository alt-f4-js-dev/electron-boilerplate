document.addEventListener("DOMContentLoaded", function (event) {
  let waiverPermint = document.getElementById("SubmInfo_LateDateOfWrtnPerm10")
    .value;

  if (waiverPermint.length === 0) {
    document.getElementById("PartOfAppl_ApplTp10").removeAttribute("options");
    document
      .getElementById("PartOfAppl_ApplTp10")
      .setAttribute(
        "options",
        "Request for TOP/CSC Clearance of Works Completed:Request for TOP/CSC Clearance of Works Completed"
      );
  }
});
...
function PartOfAppl_SubmTp_Change(element) {
  if (
    ...
    //for submission no of parent written permission
    if (
      document
        .getElementById("PartOfAppl_SubmNoPareWrit")
        .hasAttribute("hidden")
    )
      document
        .getElementById("PartOfAppl_SubmNoPareWrit")
    ...
    document
      .getElementById("PartOfAppl_SubmNoPareWrit10")
      .setAttribute("mandatory", "");

    if (
      document
        .getElementById("PartOfAppl_SubmNoPareWrit2")
        .hasAttribute("hidden")
    )
      document
        .getElementById("PartOfAppl_SubmNoPareWrit2")
        .removeAttribute("hidden");
    document
      .getElementById("PartOfAppl_SubmNoPareWrit20")
      .setAttribute("mandatory", "");
  }
  if (
    element.value ===
    ...
    document
      .getElementById("PartOfAppl_SubmNoPareWrit")
      .setAttribute("hidden", "");
    document.getElementById("PartOfAppl_SubmNoPareWrit10").value = "";
    if (
      document
        .getElementById("PartOfAppl_SubmNoPareWrit10")
        .hasAttribute("data-invalid")
    ...
    document
      .getElementById("PartOfAppl_SubmNoPareWrit2")
      .setAttribute("hidden", "");
    document.getElementById("PartOfAppl_SubmNoPareWrit20").value = "";
    if (
      document
        .getElementById("PartOfAppl_SubmNoPareWrit20")
        .hasAttribute("data-invalid")
...
function populateSiteNos(siteAddressFormPrefix) {
  //NOTE first paremeter for this functions must be the id of site address section
  //     the succeeding paremeters will be the id of the main-container
  //     e.g. event-change="populateSiteNos('siteAddressId10', 'buildingPlanContainerId10', 'SubmissionInfoId10')"
  let options = "1:1";
...
function PartOfAppl_ApplTp10_Change(element) {
  if (element.value === "CCAI") {
    document.getElementById("BldgPln_SiteAddrId10").value = "1";
    document.querySelector('[target="page9"]').removeAttribute("hidden");
    document.getElementById("LateWritPermAppr").removeAttribute("hidden");
    document.getElementById("DetaOfLodgAuth").removeAttribute("hidden");
    if (document.querySelector('[target="page7"]').hasAttribute("hidden")) {
      document.getElementById("page7").removeAttribute("hidden");
      ...
      document
        .querySelector('[target="page9"]')
        .setAttribute("page-number", "9");
      setMToMandatory(document.getElementById("page7").querySelectorAll("tr"));
    }

    if (document.getElementById("DeclCcai").hasAttribute("hidden")) {
      document.getElementById("DeclCcai").removeAttribute("hidden");

      document.getElementById("DeclCpai").setAttribute("hidden", "");
      document.getElementById("DeclCpai").querySelector("cn2-textbox").value =
        "";

      document.getElementById("DeclUrai").setAttribute("hidden", "");
      document.getElementById("DeclUrai").querySelector("cn2-textbox").value =
        "";
    }
    document
      .getElementById("DeclCcai")
      .querySelectorAll('[type="radio"]')[0]
  ...
  if (element.value === "CPAI") {
    ...
    if (document.getElementById("DeclCpai").hasAttribute("hidden")) {
      document.getElementById("DeclCpai").removeAttribute("hidden");

      document.getElementById("DeclCcai").setAttribute("hidden", "");
      document.getElementById("DeclCcai_Conserved").setAttribute("hidden", "");
      document
        .getElementById("DeclCcai_ConservedAndNon")
        .setAttribute("hidden", "");
      document
        .getElementById("DeclCcai")
        .querySelectorAll("cn2-textbox")[0].value = "";
      document
        .getElementById("DeclCcai")
        .querySelectorAll('[type="radio"]')[0].checked = false;
      document
        .getElementById("DeclCcai")
        .querySelectorAll('[type="radio"]')[0]
      ...
      document
        .getElementById("DeclCcai")
        .querySelectorAll('[type="radio"]')[1].checked = false;
      document
        .getElementById("DeclCcai")
        .querySelectorAll('[type="radio"]')[1]
        .removeAttribute("checked");
  ...
  if (element.value === "URAI") {
    document.querySelector('[target="page9"]').removeAttribute("hidden");
    document.getElementById("page7").setAttribute("hidden", "");
    document.getElementById("LateWritPermAppr").removeAttribute("hidden");
    document.getElementById("DetaOfLodgAuth").removeAttribute("hidden");
    document.querySelector('[target="page7"]').setAttribute("hidden", "");
    document.querySelector('[target="page8"]').setAttribute("page-number", "7");
    document.querySelector('[target="page9"]').setAttribute("page-number", "8");
    emptyValueAll("page7");
    setMandatoryToM(document.getElementById("page7").querySelectorAll("tr"));

    if (document.getElementById("DeclUrai").hasAttribute("hidden")) {
      document.getElementById("DeclUrai").removeAttribute("hidden");
    ...
    let buildingPlanChildren = document
      .getElementById("page7")
      .querySelectorAll('[prefix="buildingPlanChild"]');
    if (buildingPlanChildren.length > 1) {
      for (let x = buildingPlanChildren.length - 1; x > 0; x--) {
        removeOneForm("buildingPlan", buildingPlanChildren[x].id);
      }
    }
  }
}

function selectDeclTopc(callerElementId) {
  document.getElementById("DeclTopc_ConsBldgStru10").removeAttribute("checked");
  document
    .getElementById("DeclTopc_ConsBldgStru10")
    .removeAttribute("mandatory");

  document
    .getElementById("DeclTopc_ConsAndNonCons10")
    .removeAttribute("checked");
  document
    .getElementById("DeclTopc_ConsAndNonCons10")
    .removeAttribute("mandatory");
  if (callerElementId === "DeclTopc_ConsBldgStru10") {
    document.getElementById("DeclCcai_Conserved").removeAttribute("hidden");
    document
      .getElementById("DeclCcai_ConservedAndNon")
      .setAttribute("hidden", "");
  } else {
  ...
  let data = [
    {
      URA: [
        {
          Email: "ura_daes_registry@ura.gov.sg",
          TelNo: "63293237",
...
function emptyAllFields(section) {
  let radiobuttons = section.querySelectorAll("input[type=radio]");
  let checkboxes = section.querySelectorAll("cn2-checkbox");
  let textboxes = section.querySelectorAll("cn2-textbox");
  let textareas = section.querySelectorAll("cn2-textarea");
  let datefields = section.querySelectorAll("cn2-datefield");

  for (let radio of radiobuttons) {
    radio.checked = false;
    if (radio.hasAttribute("mandatory")) radio.removeAttribute("mandatory");
  }

  for (let checkbox of checkboxes) {
    checkbox.checked = false;
    if (checkbox.hasAttribute("mandatory"))
      checkbox.removeAttribute("mandatory");
  }

  for (let textbox of textboxes) {
    textbox.value = "";
    if (textbox.hasAttribute("mandatory")) textbox.removeAttribute("mandatory");
  }

  for (let textarea of textareas) {
    textarea.value = "";
    if (textarea.hasAttribute("mandatory"))
...
function subType(el, newSubs, reSubs) {
  if (el.value == "New Submission") {
    document.getElementById(reSubs[0]).setAttribute("hidden", "");
    document.getElementById(reSubs[1]).value = "";
    document.getElementById(reSubs[1]).removeAttribute("mandatory");
    ...
    for (let newM of document
      .getElementById("DeclGeneNewSubm10")
      .querySelectorAll("[mandatory]")) {
      document.getElementById(newM.id).removeAttribute("mandatory");
      document.getElementById(newM.id).setAttribute("m", "");
    }
    for (let resubM of document
      .getElementById("DeclGeneResu10")
      .querySelectorAll("[m]")) {
      document.getElementById(resubM.id).removeAttribute("m");
      document.getElementById(resubM.id).setAttribute("mandatory", "");
    }
  } else {
    document.getElementById(reSubs[0]).removeAttribute("hidden");
    document.getElementById(reSubs[1]).setAttribute("mandatory", "");
    ...
    for (let resubM of document
      .getElementById("DeclGeneResu10")
      .querySelectorAll("[mandatory]")) {
      document.getElementById(resubM.id).removeAttribute("mandatory");
      document.getElementById(resubM.id).setAttribute("m", "");
    }
    for (let newM of document
      .getElementById("DeclGeneNewSubm10")
      .querySelectorAll("[m]")) {
      document.getElementById(newM.id).removeAttribute("m");
      document.getElementById(newM.id).setAttribute("mandatory", "");
    }
  }
}
...
function checkSiteAddressDuplicate(formId, elementId) {
  ...
  if (formsCount > 1) {
    for (let x = 0; x < formsCount; x++) {
      for (let y = 0; y < formsCount; y++) {
        if (x != y) {
          ...
          for (let z = 0; z < textboxes1.length; z++) {
            if (
              textboxes1[z].value != textboxes2[z].value &&
              textboxes1[z].value != ""
            ) {
              hasDuplicate = false;
              break;
          ...
          for (let z = 0; z < selects1.length; z++) {
            if (
              selects1[z].value != selects2[z].value &&
              selects1[z].value != ""
            ) {
              hasDuplicate = false;
              break;
      ...
      if (hasDuplicate) {
        showMessage("Cannot have duplicate Side Address.");
        document.getElementById(elementId).value = "";
        if (
          document.getElementById(elementId).hasAttribute("options") ||
          document.getElementById(elementId).hasAttribute("data-options")
        ) {
...
//for site address road name and locality desc
// function siteAddressMandatoryField(elementId) {
//   let container = document.getElementById(elementId).parentNode;

//   while (
//     container.querySelectorAll("[road-name]").length == 0 ||
//     container.querySelectorAll("[locality-description]").length == 0
//   ) {
//     container = container.parentNode;
//   }

//   let roadName = container.querySelector("[road-name]");
//   let localityDescription = container.querySelector("[locality-description]");

//   if (roadName.value === "" && localityDescription.value === "") {
...
function populateSignedByGene2(persAndOrgsRoleId, persAndOrgsNameId) {
    ...
    if (
      ...
      if (
        ...
        document.getElementById(
          "DeclGene2_QPName10"
        ).value = document.getElementById(namePrefix + ctr + nameSuffix).value;
        break;
      }
    }
    ctr++;
...
function duplicateForm(formContainer, fieldContainer, field, status) {
  ...
  if (clonedForm.querySelector("[role-name]")) {
    clonedForm.querySelector("[role-name]").setAttribute("disabled", "");
    clonedForm.querySelector("[role-name]").removeAttribute("disabled");
  }
  ...
  if (status == "multiple") {
    ...
    clonedForm.querySelector("[role-name]").removeAttribute("trio");
    clonedForm.querySelector("[role-name]").setAttribute("general", "");
    clonedForm.querySelector("[role-name]").removeAttribute("options");
    clonedForm.querySelector("[role-name]").setAttribute("options", newOptions);
  }
  ...
  if (clonedForm.querySelector("[qp-label]")) {
    clonedForm.querySelector("[qp-reg-no]").setAttribute("mandatory", "");
...
function Member_Cont_Email_Address_QPHandNoTelNo_Change(
  element,
  targetId1,
  targetId2
) {
...
function autoInsertPersonAndOrg(roles, params) {
  if (roles != "multiple") {
    ...
    let role = document.getElementById(clone.id).querySelector("[role-name]");
    let qpLabel = document.getElementById(clone.id).querySelector("[qp-label]");
    let qp = document.getElementById(clone.id).querySelector("[qp-reg-no]");
...
function checkRoleInput(element, con) {
  ...
  if (
    ...
    if (value == "Agent (i.e. QP)") {
      replacement.setAttribute(
        "event-change",
        "loadDropDownDetailsURA(this);populateSignedBy('MemberRole_Member_Role_Code_Desc_QP10', 'Member_Member_Name_QP10');"
      );
    } else {
      replacement.setAttribute("event-change", "loadDropDownDetailsURA(this);");
    }
  ...
  let road = document.getElementById(con).querySelector("[road-name]");
  ...
  let postal = document.getElementById(con).querySelector("[formatted-postal]");
        ...
        if (general2) {
          ...
          if (document.getElementById("DeclGeneNewSubm_SignedBy10"))
            document.getElementById(
              ...
              .getElementById(namePrefix + ctr + nameSuffix)
          ...
          if (document.getElementById("DeclGeneResu_SignedBy10"))
            document.getElementById("DeclGeneResu_SignedBy10").value = document
              .getElementById(namePrefix + ctr + nameSuffix)
              .shadowRoot.querySelector("select")
              .querySelector(
                "option[value=" +
          ...
          if (document.getElementById("DeclTopc_SignBy10"))
            document.getElementById("DeclTopc_SignBy10").value = document
              .getElementById(namePrefix + ctr + nameSuffix)
              .shadowRoot.querySelector("select")
              .querySelector(
                "option[value=" +
          ...
          if (document.getElementById("DeclTopCscMonu_SignBy10"))
            document.getElementById("DeclTopCscMonu_SignBy10").value = document
              .getElementById(namePrefix + ctr + nameSuffix)
              .shadowRoot.querySelector("select")
              .querySelector(
                "option[value=" +
          ...
          if (document.getElementById("DeclTOPCNonCons_SignBy10"))
            document.getElementById("DeclTOPCNonCons_SignBy10").value = document
              .getElementById(namePrefix + ctr + nameSuffix)
              .shadowRoot.querySelector("select")
              .querySelector(
                "option[value=" +
  ...
  if (!document.querySelector("[target='page1']").hasAttribute("valid")) {
    let run = setTimeout(() => {
      for (let a of document.querySelectorAll("[role-name]")) {
        ...
        if (isDisabled) a.removeAttribute("disabled");
        if (a.tagName.toLowerCase() == "cn2-select")
          a.shadowRoot.querySelector("select").onchange();
        else a.shadowRoot.querySelector("input").onchange();
        if (isDisabled) a.setAttribute("disabled", "");
      }
      ...
      duplicateForm = (formContainer, fieldContainer, field, status) => {
        ...
        if (clonedForm.querySelectorAll("[name], input[type='radio']")) {
          let radios = clonedForm.querySelectorAll(
        ...
        let runThis = setTimeout(() => {
          ...
          if (
            ...
            if (value == "Agent (i.e. QP)") {
              replacement.setAttribute(
                "event-change",
                `loadDropDownDetailsURA(this); populateSignedBy('MemberRole_Member_Role_Code_Desc_${ext}', 'Member_Member_Name_${ext}');`
              );
            } else {
              replacement.setAttribute(
                "event-change",
          ...
          if (road.hasAttribute("disabled")) road.removeAttribute("disabled");
          if (road.hasAttribute("options")) road.removeAttribute("options");
          if (road.hasAttribute("data-options"))
            road.removeAttribute("data-options");
          if (road.hasAttribute("mandatory")) road.removeAttribute("mandatory");
          if (road.hasAttribute("event-change"))
            road.removeAttribute("event-change");
          if (road.tagName.toLowerCase() == "cn2-select") {
            road.setAttribute("data-options", "roadNameDropdown");
            road.setAttribute("mandatory", "");
          } else {
          ...
          if (postal.hasAttribute("disabled"))
            postal.removeAttribute("disabled");
          if (postal.hasAttribute("mandatory"))
      ...
      setQpRegNoMandatory = (element, form) => {
        let runThis = setTimeout(() => {
          let index = form.replace(
            document.getElementById(form).getAttribute("prefix"),
            ""
          );
          if (index >= 40) {
            let boxes = document
              .getElementById(form)
              .querySelectorAll("cn2-textbox,cn2-datefield");
            for (let y of boxes) {
              y.value = "";
            }
          }
          ...
          if (element.value === "Architect" || element.value === "Engineer") {
            ...
            document
              .getElementById(form)
              .querySelector("[qp-label]").innerHTML = "QP Registration No. *";
          } else {
            document
              .getElementById(form)
              .querySelector("[qp-reg-no]")
      ...
      populateSignedBy = (persAndOrgsRoleId, persAndOrgsNameId, general2) => {
        let runThis = setTimeout(() => {
          ...
          let ctr = 1;
          while (
            document.getElementById(rolePrefix + ctr + roleSuffix) != null
          ) {
            if (
              document.getElementById(rolePrefix + ctr + roleSuffix).value !=
                "" &&
...
function validateSiteDetails() {
  let values = {
    ...
    pedestrian_link: document.getElementById(
      "SiteAddr_IsTheBldgWithPedeLink_Yes10"
    ).checked
      ? "Y"
      : "N",
  };
  ...
  if (Object.values(values).every((i) => i != "")) {
    let response = ipcRenderer.sendSync(
      ...
      ["443", "/corenet2DS/forms/rest/validateLodgmentAddress", values]
    );
    ...
    if (response["is_valid"] && response["msg"]) {
      if (response["is_valid"] == "Y") {
        for (let a of [
          "SiteAddr_HseBlkNo10",
          "SiteAddr_BldgNm10",
          "SiteAddr_Unit_Floor10",
          "SiteAddr_Unit_Unit10",
          "SiteAddr_PostCd10",
        ]) {
          validMessage(a, "");
        }
    ...
    response = ipcRenderer.sendSync(
      "client-request",
      "POST",
      ["https:", "www.ura.gov.sg"],
      ["443", "/corenet2DS/forms/rest/getCULodgementUse", values]
    );

    if (
      response["predefined_use"] == "Y" &&
      response["proposed_use"].length > 0
    ) {
      let newUses = [];
      let newUseCodes = [];
      ...
      document
        .getElementById("SiteAddr_PropUse10")
        .removeAttribute("data-options");
      document
        .getElementById("SiteAddr_PropUse10")
        .setAttribute("options", newUses.join(","));
      document
        .getElementById("SiteAddr_PropUse10")
        .setAttribute("road-codes", newUseCodes.join(","));
...
function populateWP(isValid, data) {
  let fields = [
    "SubmInfo_LateDateOfWrtnPerm10",
    "SubmInfo_DCRefeOfWrit10",
    "SubmInfo_DateOfWritPerm10",
    "SubmInfo_WritPermDeciNo10",
    "SubmInfo_ApvdPlanNo10",
  ];
  ...
  if (!isValid) {
    ...
    document.getElementById("SubmInfo_LateDateOfWrtnPerm10").value =
      data["wp_submission_no"];
    document.getElementById("SubmInfo_DCRefeOfWrit10").value =
      data["wp_dc_referene"];
    let validDate = "";
    ...
    document.getElementById("SubmInfo_WritPermDeciNo10").value =
      data["wp_decision_no"];
    document.getElementById("SubmInfo_ApvdPlanNo10").value =
      data["wp_approved_plan_no"];
  }
}
...
function validateMukim(element) {
  ...
  if (pass) {
    let response = ipcRenderer.sendSync(
      ...
      [
        "443",
        "/corenet2DS/forms/rest/validateLotNo",
        [
          {
            mkts_ind:
              [...getMukimCon(el).querySelectorAll("input[event-container]")]
                .filter((el) => el.checked)
                .map((el) => el.getAttribute("prefix"))[0] == "MkTs_MkTs_Mk"
                ? "mk"
                : "ts",
            mkts_no: getMukimCon(el)
              .querySelector("cn2-textbox[prefix='MkTs_MkTsNo']")
              .value.trim(),
            lot_no: getMukimCon(el)
              .querySelector("cn2-textbox[prefix='MkTs_LotNo']")
              .value.trim(),
          },
        ],
      ]
    ...
    if (response["is_valid"] && response["msg"]) {
      if (response["is_valid"] == "Y") {
        showMessage(response["msg"]);
        for (let a of getMukimCon(el).querySelectorAll(
          "cn2-textbox[event-container]"
        )) {
          validMessage(a.id, "");
        }
      } else if (response["is_valid"] == "N") {
...
function validatePrevSub(element) {
  ...
  if (pass) {
    ...
    let response = ipcRenderer.sendSync(
      ...
      [
        "443",
        "/corenet2DS/forms/rest/validateRebub",
        {
          form_id: "FTPCSCLR",
          application_type: appType,
          submission_no: el.value,
...
document.addEventListener("DOMContentLoaded", () => {
  if (!document.querySelector("[target='page1']").hasAttribute("valid")) {
    let appType = [...document.querySelectorAll("[label]")].filter((i) =>
      i.getAttribute("label").includes("Application Type")
    )[0];
    appType = appType ? appType : "";
    let lodgement = [...document.querySelectorAll("[label]")].filter((label) =>
...
function updateHeaderDisplay(appEl, lodgeEl) {
  let run = setTimeout(() => {
    ...
    if (appEl) {
      ...
      appVal = [...document.querySelectorAll("[label]")]
        .filter((i) => i.getAttribute("label").includes("Application Type"))[0]
        .value.trim();
    }
    ...
    if (lodgeEl) {
      ...
      lodgeVal = [...document.querySelectorAll("[label]")].filter((label) =>
        label.getAttribute("label").toLowerCase().includes("lodgement type")
      )[0]
    ...
    if (
      !header.hasAttribute("raw-title") ||
      header.getAttribute("raw-title").trim() == ""
    )
...
function updateRoadName(con) {
  let run = setTimeout(() => {
    ...
    if (jsonData["roadNameDropdown" + code]) {
      let newOptions = jsonData["roadNameDropdown" + code]
        .map((roadList) => roadList[road.getAttribute("prefix") + "10"])
        .map((list) => list + ":" + list)
        .join(",");
  ...
  if (val.trim()) {
    ...
    for (let a of con.querySelectorAll("[prefix]")) {
      ...
      if (prefixes.includes(prefix)) {
        ...
        a.setAttribute(
          "id",
          ["DEVP", "OWN"].includes(val)
            ? a
                .getAttribute("id")
                .replace(rawPre, a.getAttribute("prefix"))
                .slice(0, -2) + "10"
            : a.getAttribute("id").replace(rawPre, a.getAttribute("prefix"))
        );
        jsonData[
