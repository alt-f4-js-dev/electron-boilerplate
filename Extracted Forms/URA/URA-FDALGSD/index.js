function showMessagesurveyor() {
  alert("'Registered surveyor' means a person who is registered as a land surveyor under the Land Surveyors Act (Cap. 156) and who has in force a practising certificate issued under that Act.")
}

function showMessageCommProp() {
  alert("'Common property' means such part or parts of the land or buildings comprised in a development of land as may be specified or described in the written permission granted for the development of land or the plans approved by the competent authority in the grant for such permission to be common property or communal open space.")
}

function PartOfAppl_ApplTp10_change(element) {
  document.getElementById("PartOfAppl_LodgTp10").value = "Subdivision";
}
