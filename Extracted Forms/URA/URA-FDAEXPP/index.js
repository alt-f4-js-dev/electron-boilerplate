...
function validateParProvPer(element) {
  ...
  if (pass) {
    ...
    let response = ipcRenderer.sendSync("client-request", "POST", ["https:", "www.ura.gov.sg"], ["443", "/corenet2DS/forms/rest/validateExtension", {
      form_id: "FDAEXPP",
