function PartOfAppl_SIPDIPFromCBPU_RefeNumb10_change(element) {
  let dateField = document.getElementById("PartOfAppl_Date_SIPDIPFromCBPU10");
...
function PartOfAppl_RefeNumb_DCCleaFromCBPU10_change(element) {
  let dateField = document.getElementById("PartOfAppl_Date_DCCleaFromCBPU10");
...
document.addEventListener("DOMContentLoaded", function (event) {
  document.querySelector("cn2-master-head").setAttribute(
    "title",
    `APPLICATION FOR CLEARANCE CERTIFICATE FOR BUILDING PLAN ON POLLUTION CONTROL FOR INDUSTRIAL PLANT WORKS - RESUBMISSION
  <br>[UNDER SECTION 33(1) OF THE ENVIRONMENTAL PROTECTION AND MANAGEMENT ACT (EPMA), Chapter 94A]`
  );
